...
You can send emails from any email address you have. Allow up to 24 hours for a response if you send an email on a weekday. Over the weekend, response times may be longer. Please be patient.
